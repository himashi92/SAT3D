...
class PatchMerging(nn.Module):
    ...
    def forward(self, x):
        ...
        x2 = x[:, 1::2, 0::2, 1::2, :]  # B D H/2 W/2 C
        x3 = x[:, 1::2, 1::2, 1::2, :]  # B D H/2 W/2 C
        x = torch.cat([x0, x1, x2, x3], -1)  # B D H/2 W/2 6*C
...
class SwinTransformerUASAM3D(nn.Module):
    r""" Swin Transformer
    ...
    def __init__(self, pretrained=None,
        ...
        print(
            "SwinTransformerSys3DPlus expand initial----depths:{};depths_decoder:{};drop_path_rate:{};num_classes:{};embed_dims:{};window:{}".format(
                depths,
...
if __name__ == "__main__":
    ...
    network = SwinTransformerUASAM3D(
            img_size=(128, 128, 128),
            patch_size=(2, 2, 2),
